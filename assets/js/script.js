...
const gameStartListener = () => {
  ...
  playerOneName = playerOneNameInput.value.trim().charAt(0).toUpperCase() + playerOneNameInput.value.trim().slice(1);
  playerTwoName = playerTwoNameInput.value.trim().charAt(0).toUpperCase() + playerTwoNameInput.value.trim().slice(1);
...
document.getElementById("playerOne").addEventListener("keypress", Enterkey);
document.getElementById("playerTwo").addEventListener("keypress", Enterkey);
startGame();
